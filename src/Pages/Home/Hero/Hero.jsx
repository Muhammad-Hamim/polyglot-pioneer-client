    ...
    <>
      <div className="py-3 px-8">
        <div className="max-w-screen-xl mx-auto grid items-center min-h-[80vh] lg:grid-cols-2 gap-6">
          <div className=" space-y-6">
            <h2 className="text-3xl mt-4 lg:mt-0 lg:text-5xl text-gray-900 font-bold">
      ...
      <div className=" bg-indigo-600 w-full">
        <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex gap-3 items-center border-b-[1px] lg:border-r-[1px] border-indigo-200 py-12">
            <div>
